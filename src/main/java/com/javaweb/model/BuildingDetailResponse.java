...
/**
 * DTO trả về đầy đủ thông tin một tòa nhà — dùng cho modal sửa.
 */
public class BuildingDetailResponse {
    ...
    public List<Integer> getRentAreas() { return rentAreas; }
    public void setRentAreas(List<Integer> rentAreas) { this.rentAreas = rentAreas; }

    public List<String> getBuildingTypes() { return buildingTypes; }
    public void setBuildingTypes(List<String> buildingTypes) { this.buildingTypes = buildingTypes; }
